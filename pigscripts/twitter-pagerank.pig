...
%default OUTPUT_PATH 's3n://my-output-bucket/$MORTAR_EMAIL_S3_ESCAPED/twitter-pagerank'

/**
 * User-Defined Functions (UDFs)
 */
REGISTER '../udfs/python/twitter-pagerank.py' USING streaming_python AS twitter-pagerank;
...
with_udf_output = FOREACH filtered 
                 GENERATE field0..field2, 
                          twitter-pagerank.example_udf(field0) AS example_udf_field;
